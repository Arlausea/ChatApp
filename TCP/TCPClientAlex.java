...
public class TCPClient {
    ...
    /**
     * Connects to the server and starts the communication.
     */
    public void launch() {
    ...
    /**
     * Determines if the user input is a valid message.
     *
     * @param message the user input
     * @return true if the message is non-empty, false otherwise
     */
    private boolean isValidMessage(String message) {
        return message != null && !"".equalsIgnoreCase(message);
    }

    /**
     * Determines if the user input indicates an exit command.
     *
     * @param message the user input
     * @return true if the message is "exit" or null, false otherwise
     */
    private boolean isExitCommand(String message) {
        return "exit".equalsIgnoreCase(message) || message == null;
    }

    /**
     * Handles exceptions during the connection.
     *
